    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            'Messages': [
                {
                "From": {
                    "Email": "djangobackend@shopdomain.com",
                    "Name": "Enquiries"
                },
                "To": [
                    {
                    "Email": "shopowner@emailaddres.com",
                    "Name": "SHOP OWNER's NAME"
                    }
                ],
                "Subject": form.cleaned_data['subject'],
                "TextPart": "New enquiry form received from website.com/contact on " + mu_time.strftime('%Y-%m-%d %H:%M:%S') +"\n" + \
